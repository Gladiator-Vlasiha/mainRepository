...
public class Main {
    ...
    private static Logger input_errors;
    ...
    public static void main(String[] args) {
        ...
        input_errors = LogManager.getLogger("Input_errors");
        ...
        for (; ; )
            ...
            } catch (Exception ex) {exceptions.info("exceptions -"+ex);
            }
    }
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                search.info("Станция найдена в базе - " + line);
                // System.out.println("Станция  найдена !!!");
                return station;
            }

            input_errors.info("не найдена " + line);
